    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-500 via-blue-500 to-cyan-400 p-[2px] shadow-md transition-transform group-hover:scale-105">
            ...
            <div className="flex flex-col gap-4">
              {navLinks.map((link) => (
                <a
                  ...
                  href={link.href}
                  onClick={(e) => handleNavClick(e, link.href)}
                  className="text-lg font-semibold text-sub hover:text-heading py-1 transition-colors"
                >
                  {link.name}
                </a>
              ))}

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-24">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <div className="badge-pill mb-4">Technology Stack</div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {techCategories[activeTab].map((tech) => (
                  <div
                    key={tech}
                    className="glass-card px-6 py-4 rounded-xl text-base font-medium text-heading flex items-center gap-3 border border-white/10 hover:border-indigo-500/50 hover:scale-105 transition-all shadow-md"
                  >
        ...
        <div>
          <div className="text-center max-w-3xl mx-auto mb-12">
            <div className="badge-pill mb-4">Industries</div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-heading tracking-tight mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
            {industries.map((ind, idx) => (
              <motion.div
                ...
                className="glass-panel px-5 py-3 rounded-full text-sm font-medium text-sub border border-white/10 hover:border-cyan-500/40 hover:text-heading transition-all cursor-default"
              >
                {ind}
              </motion.div>
            ))}
